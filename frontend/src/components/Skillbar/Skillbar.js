...
export default class Skillbar extends React.Component {
  ...
  componentDidMount() {
    window.addEventListener("scroll", () => {
      this.animate(document.getElementById(this.props.id));
    });
  }
  ...
  animate(element) {
    ...
    // is element in view?
    if (this.inView(element) && this.state.style !== "skill_inner-bar skill_inner-bar-val") {
      // element is in view, add class to element
      this.setState({ style: "skill_inner-bar skill_inner-bar-val" });
